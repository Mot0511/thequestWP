			...
			<div class="row">
				<div class="col-lg-8 blog-posts">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="blog-post">
								<img src="<?php echo get_template_directory_uri()?>/img/blog/4.jpg" alt="">
								<div class="post-date">April 1,2019</div>
								<h4>The best games of 2019</h4>
								<div class="post-metas">
									<div class="post-meta">By Admin</div>
						...
						<div class="col-md-6">
							<div class="blog-post">
								<img src="<?php echo get_template_directory_uri()?>/img/blog/5.jpg" alt="">
								<div class="post-date">April 1,2019</div>
								<h4>Tips to play a better game</h4>
								<div class="post-metas">
									<div class="post-meta">By Admin</div>
			...
			<div class="row">
				<div class="col-lg-8">
					<div class="small-blog-list">
						...
						<div class="sb-item">
							<img src="<?php echo get_template_directory_uri()?>/img/blog-thumbs/7.jpg" alt="">
							<div class="sb-text">
								<div class="sb-date">April 1,2019</div>
								<h6>10 Amazing new games</h6>
								<div class="sb-metas">
						...
						<div class="sb-item">
							<img src="<?php echo get_template_directory_uri()?>/img/blog-thumbs/8.jpg" alt="">
							<div class="sb-text">
								<div class="sb-date">April 1,2019</div>
								<h6>10 Amazing new games</h6>
								<div class="sb-metas">
						...
						<div class="sb-item">
							<img src="<?php echo get_template_directory_uri()?>/img/blog-thumbs/9.jpg" alt="">
							<div class="sb-text">
								<div class="sb-date">April 1,2019</div>
								<h6>10 Amazing new games</h6>
								<div class="sb-metas">
					...
					<div class="sb-widget">
						...
						<div class="latest-news-widget top-five">
							...
							<div class="ln-item">
								...
								<img src="<?php echo get_template_directory_uri()?>/img/blog-thumbs/5.jpg" alt="">
								<div class="ln-text">
									<div class="ln-date">April 1, 2019</div>
									<h6>10 Amazing new games</h6>
									<div class="ln-metas">
